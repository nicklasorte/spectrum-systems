...
| SYS-004 Spectrum Study Compiler | Compiler passes across artifacts and manifests | `eval/study-artifacts` (compiler-focused cases pending) | Manifest completeness, pass/fail signaling, packaging accuracy, propagation of warnings | Missing manifest fields, emitted artifacts without validation, dropped warnings/errors |
