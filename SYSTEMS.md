...
| Spectrum Study Compiler | SYS-004 | BN-003 packaging and validation of study deliverables | systems/spectrum-study-compiler/overview.md | schemas/study-output-schema.json, schemas/provenance-schema.json | prompts/report-drafting.md (compiler-aware) | eval/study-artifacts |
