...
def test_standards_manifest_registers_exception_router_contracts() -> None:
    ...
    assert standards["failure_taxonomy_record"]["schema_version"] == "1.0.0"
    ...
    assert standards["policy_candidate_record"]["schema_version"] == "1.0.0"
    assert standards["policy_activation_record"]["schema_version"] == "1.0.0"
