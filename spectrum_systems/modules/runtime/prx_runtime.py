"""PRX deterministic runtime for ADV-001."""
...
class PRXRuntimeError(ValueError):
    """Raised when PRX runtime checks fail closed."""
...
def _require_mapping(value: Any, field: str) -> Mapping[str, Any]:
    if not isinstance(value, Mapping):
        raise PRXRuntimeError(f"{field} must be an object")
    return value
...
def build_effectiveness_artifact(*, eval_artifact: Mapping[str, Any], replay_result: Mapping[str, Any]) -> dict[str, Any]:
    artifact = {
        ...
        "schema_version": "1.0.0",
        "artifact_id": _stable_id("prx-effect", [eval_artifact, replay_result]),
    ...
    validate_artifact(artifact, "prx_precedent_score_report")
    return artifact
...
def run_red_team_round(*, fixture: Mapping[str, Any]) -> dict[str, Any]:
    ...
    artifact = {
        ...
        "schema_version": "1.0.0",
        "artifact_id": _stable_id("prx-bundle", base),
    ...
    validate_artifact(artifact, "prx_precedent_bundle")
    return artifact
