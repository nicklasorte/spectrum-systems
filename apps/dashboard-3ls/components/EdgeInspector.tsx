...
export function EdgeInspector({ edge }: Props) {
  ...
  return (
    <div className="border dark:border-slate-700 rounded p-3 text-sm space-y-2 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100" data-testid="edge-inspector">
      <header>
