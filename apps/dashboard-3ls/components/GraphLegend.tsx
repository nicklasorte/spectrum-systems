...
export function GraphLegend() {
  return (
    <div className="border dark:border-slate-700 rounded p-3 text-xs space-y-3 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100" data-testid="graph-legend">
