        ...
        <section className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded p-4 space-y-3" data-testid="diagnostics-tab">
          ...
          <div data-testid="diagnostics-intelligence-panel" className="border border-gray-200 dark:border-gray-700 rounded p-3 space-y-1 bg-white dark:bg-gray-900">
            ...
            <div className="grid gap-2 md:grid-cols-2">
              <div data-testid="learning-loop-section" className="text-xs p-2 rounded border border-gray-200 dark:border-gray-700">Learning Loop moved to Diagnostics</div>
              <div data-testid="failure-explanation-section" className="text-xs p-2 rounded border border-gray-200 dark:border-gray-700">Failure Explanation moved to Diagnostics</div>
              <div data-testid="override-unknowns-section" className="text-xs p-2 rounded border border-gray-200 dark:border-gray-700">Override / Unknowns moved to Diagnostics</div>
              <div data-testid="fallback-reduction-section" className="text-xs p-2 rounded border border-gray-200 dark:border-gray-700">Fallback Reduction moved to Diagnostics</div>
              <div data-testid="replay-lineage-hardening-section" className="text-xs p-2 rounded border border-gray-200 dark:border-gray-700">Replay + Lineage Hardening moved to Diagnostics</div>
              <div data-testid="candidate-closure-section" className="text-xs p-2 rounded border border-gray-200 dark:border-gray-700">Candidate Closure moved to Diagnostics</div>
              <div data-testid="debug-explanation-index-section" className="text-xs p-2 rounded border border-gray-200 dark:border-gray-700">Debug Explanation Index moved to Diagnostics</div>
              <div data-testid="trend-frequency-honesty-section" className="text-xs p-2 rounded border border-gray-200 dark:border-gray-700">Trend / Frequency Honesty moved to Diagnostics</div>
              <div data-testid="evl-handoff-observations-section" className="text-xs p-2 rounded border border-gray-200 dark:border-gray-700">EVL Handoff Observations moved to Diagnostics</div>
              <div data-testid="artifact-integrity-section" className="text-xs p-2 rounded border border-gray-200 dark:border-gray-700">Artifact Integrity moved to Diagnostics</div>
            </div>
          </div>
