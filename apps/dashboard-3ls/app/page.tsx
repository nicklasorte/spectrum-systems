...
type MetCockpitBlock = IntelligenceBlockEnvelope & {
  ...
  merge_conflict_pressure_state?: string;
  missing_source_artifacts?: string[];
  status?: string;
};
...
type IntelligencePayload = {
  ...
  merge_conflict_pressure?: GenericRowsBlock;
              ...
              return (
                <div className="text-sm space-y-2" data-testid="met-cockpit-card">
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 text-xs">
                    ...
                    <li>merge conflict pressure: <strong data-testid="met-merge-conflict-pressure">{cockpit?.merge_conflict_pressure_state ?? 'unknown'}</strong></li>
                  </ul>
