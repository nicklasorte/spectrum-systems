...
ADRs capture major ecosystem design choices, the context that shaped them, and the consequences for downstream engines. They keep governance decisions lightweight, searchable, and traceable to Claude design reviews. Start new ADRs from `ADR-TEMPLATE.md`, use zero-padded numbers, and update this index when proposals are accepted or superseded.

| ADR | Title | Status | Date |
| --- | --- | --- | --- |
| [ADR-001](ADR-001-ecosystem-operating-model.md) | Ecosystem operating model | Accepted | 2026-03-15 |
| [ADR-002](ADR-002-system-maturity-model.md) | System maturity model | Accepted | 2026-03-15 |
