...
- required tests/eval coverage: `tests/test_core_loop_pre_pr_gate.py`, `tests/test_agent_core_loop_proof.py`, contract compliance signal checks and authority guards.
