...
| spectrum_systems/modules/runtime/trace_engine.py | MODIFY | Add optional isolated trace-store injection seam required to avoid global trace-store mutation in runtime-reachable chaos validation. |
