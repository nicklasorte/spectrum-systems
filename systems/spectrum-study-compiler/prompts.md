...
The compiler primarily orchestrates artifacts produced by `prompts/report-drafting.md` and uses `prompts/spectrum-study-compiler.md` for validation, diagnostics, and packaging summaries.
...
- **Outputs**: Compiler manifest summaries, optional narrative adjustments, diagnostics tied to artifacts/sections, and reviewer notes.
